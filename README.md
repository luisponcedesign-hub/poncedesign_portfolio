...
assets/img/showcase/    hero carousel crops    ← generated by scripts/showcase.py
...
The home page carousel is the `"showcase"` list in `data/projects.json`: each
entry names a case study image, the caption shown on hover (`name`), and the
